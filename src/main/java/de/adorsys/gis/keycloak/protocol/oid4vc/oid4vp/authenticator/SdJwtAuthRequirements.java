...
public class SdJwtAuthRequirements {
        ...
        public PresentationRequirements getPresentationDefinition() {
                ...
                return definition
                                .addClaimRequirement(SdJwtCredentialBuilder.VERIFIABLE_CREDENTIAL_TYPE_CLAIM,
                                                expectedVctsPattern)
                                .addClaimRequirement(
        ...
        public PresentationDefinition getDIFPresentationDefinition() {
                return sdJwtCredentialConstrainer.generatePresentationDefinition(getExpectedVcts(),
                                getRequiredClaims());
        }
