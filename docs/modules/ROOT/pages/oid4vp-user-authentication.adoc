...
The single SdJwt authenticator in the flow is pre-configured with sensible defaults that can be adjusted to meet specific needs, including the accepted credential types, the maximum age of VP tokens presented, and related verifier-policy settings.
