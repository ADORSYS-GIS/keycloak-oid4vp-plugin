...
For detailed deployment configuration options (`x509_hash`, `direct_post.jwt`, injected certificates,
and Terraform-style variable mapping), see link:oid4vp-deployment-configuration.adoc[OpenID4VP deployment configuration reference].
